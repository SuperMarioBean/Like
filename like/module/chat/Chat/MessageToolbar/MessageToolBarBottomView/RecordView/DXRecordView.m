...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textLabel.text = NSLocalizedStringFromTable(@"message.toolBar.record.upCancel", LIKELocalizeChat, @"Fingers up slide, cancel sending");
...
{
    _textLabel.text = NSLocalizedStringFromTable(@"message.toolBar.record.loosenCancel", LIKELocalizeChat, @"loosen the fingers, to cancel sending");
