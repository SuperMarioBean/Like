...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textLabel.text = NSLocalizedStringFromTable(@"message.toolBar.record.upCancel", @"chat", @"Fingers up slide, cancel sending");
...
{
    _textLabel.text = NSLocalizedStringFromTable(@"message.toolBar.record.loosenCancel", @"chat", @"loosen the fingers, to cancel sending");
