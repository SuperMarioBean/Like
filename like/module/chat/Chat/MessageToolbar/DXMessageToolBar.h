...
#define kTouchToRecord NSLocalizedStringFromTable(@"message.toolBar.record.touch", @"chat", @"hold down to talk")
#define kTouchToFinish NSLocalizedStringFromTable(@"message.toolBar.record.send", @"chat", @"loosen to send")
