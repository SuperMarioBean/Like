...
- (void)easemobApplication:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (launchOptions) {
        ...
        if(userInfo) {
            [[LIKEAppContext sharedInstance] didReceiveRemoteNotification:userInfo];
        }
    }
...
//#endif
    ...
    if (![self isSpecifyServer]) {
        [[EaseMob sharedInstance] registerSDKWithAppKey:@"davidfu1989#likedemo"
...
- (void)registerEaseMobNotification{
    ...
    [[EaseMob sharedInstance].chatManager addDelegate:[LIKEAppContext sharedInstance] delegateQueue:nil];
}

- (void)unRegisterEaseMobNotification{
    [[EaseMob sharedInstance].chatManager removeDelegate:[LIKEAppContext sharedInstance]];
}
