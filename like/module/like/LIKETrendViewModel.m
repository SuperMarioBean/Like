...
- (void)configureCollectionView:(UICollectionView *)collectionView
    ...
    if ([kind isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        header.genderAndAgeLabel.text = [NSString stringWithFormat:@"%@  %@", [feed[LIKEUserGender] isEqualToString:LIKEUserGenderMale]? LIKEUserGenderMale: LIKEUserGenderFemale, @"请计算获得年龄"];
        header.genderAndAgeLabel.backgroundColor = [feed[LIKEUserGender] isEqualToString:LIKEUserGenderMale]? [UIColor blueColor]: [UIColor magentaColor];
